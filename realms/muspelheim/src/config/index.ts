/**
 * Muspelheim Configuration Module
 * 
...
export function loadConfig(): RealmConfig {
  ...
  const flag = process.env.FLAG || 'YGGDRASIL{MUSPELHEIM:00000000-0000-0000-0000-000000000000}';
  const realmName = process.env.REALM_NAME || 'muspelheim';
