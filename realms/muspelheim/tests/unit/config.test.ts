...
const TEST_FLAG = 'YGGDRASIL{MUSPELHEIM:11111111-1111-4111-8111-111111111111}';
...
describe('loadConfig', () => {
  ...
  it('should load default configuration', () => {
    ...
    expect(config.realmName).toBe('muspelheim');
    expect(config.flag).toContain('YGGDRASIL{MUSPELHEIM');
  });
